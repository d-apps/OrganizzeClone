...
import br.com.d_apps.organizze.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void recuperarMovimentacoes(){
        ...
        valueEventListenerMovimentacoes = movimentacaoRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                // Recuperar todos os filhos de datasnapshot // ID filhos
    ...
    public void configuraCalendarView(){
        ...
        calendarView.setOnMonthChangedListener(new OnMonthChangedListener() {
            ...
            public void onMonthChanged(MaterialCalendarView widget, CalendarDay date) {
                ...
                // Antes de anexar novo evento, remover o anterior
                movimentacaoRef.removeEventListener(valueEventListenerMovimentacoes);

                // Toda vez que o usuário mudar o mês carregar as movimentações
                recuperarMovimentacoes();
    ...
    protected void onStop() {
        ...
        movimentacaoRef.removeEventListener(valueEventListenerMovimentacoes);
        // Liberar recursos, remove o listener do servidor
    }
